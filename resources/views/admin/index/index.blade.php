    ...
    <div class="topbar">
        <nav class="navbar-custom">
            <ul class="list-inline float-right mb-0">
                <!-- language-->
                <li
                    class="list-inline-item hide-phone app-search"
                >
                ...
                >
                    ...
                    >
                        ...
                        <a class="dropdown-item" href="#"
                            ><i
                                class="mdi mdi-wallet m-r-5 text-muted"
                            ></i>
                            My Wallet</a
                        >
                        <a class="dropdown-item" href="#"
                            ><span
                                ...
                                >5</span
                            ><i
                                class="mdi mdi-settings m-r-5 text-muted"
                            ></i>
                            Settings</a
                        >
                        <a class="dropdown-item" href="#"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="col-9 align-self-center text-right"
                                        >
                                            <div class="m-l-10">
                                                <h5
                                                    class="mt-0"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    >
                                        ...
                                        <div
                                            class="col-9 text-right align-self-center"
                                        >
                                            <div class="m-l-10">
                                                <h5
                                                    class="mt-0"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4 text-center">
                                    <h5>
                                        <i
                                            class="mdi mdi-airplane-takeoff mr-2 text-danger font-20"
                                        ></i>
                                        80%
                                    </h5>
                                    <h6 class="text-lightdark">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul
                                class="list-unstyled text-center text-muted mt-2 mb-0"
                            >
                                <li
                                    class="list-inline-item font-13"
                                >
                                    <i
                                        class="mdi mdi-album font-16 text-secondary mr-2"
                                    ></i
                                    >Laptops
                                </li>
                                <li
                                ...
                                >
                                    <i
                                        class="mdi mdi-album font-16 text-info mr-2"
                                    ></i
                                    >Iphones
                                </li>
                                <li
                                ...
                                >
                                    <i
                                        class="mdi mdi-album font-16 text-light mr-2"
                                    ></i
                                    >Tablets
                                </li>
                            </ul>
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div
                                    class="col-4 text-center align-self-center"
                                >
                                    <h6
                                        class="text-muted mt-0 font-14"
                                    >
                                        MON
                                    </h6>
                                    <canvas
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <a
                                                            href="#"
                                                            ><i
                                                                class="ti-facebook text-primary"
                                                            ></i
                                                        ></a>
                                                    </li>
                                                    <li
                                                    ...
                                                    >
                                                        <a
                                                            href="#"
                                                            ><i
                                                                class="ti-twitter-alt text-info"
                                                            ></i
                                                        ></a>
                                                    </li>
                                                </ul>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img
                                                    class=""
                                                    src="assets/images/products/pro1.png"
                                                    alt="user"
                                                />
                                            </td>
                                            <td>Chair</td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-boxed badge-success"
                                                    >Shipped</span
                                                >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img
                                                    class=""
                                                    src="assets/images/products/pro2.png"
                                                    alt="user"
                                                />
                                            </td>
                                            <td>Mobile</td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-boxed badge-danger"
                                                    >Delivered</span
                                                >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img
                                                    class=""
                                                    src="assets/images/products/pro3.png"
                                                    alt="user"
                                                />
                                            </td>
                                            <td>LED</td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-boxed badge-warning"
                                                    >Pending</span
                                                >
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <img
                                                    class=""
                                                    src="assets/images/products/pro4.png"
                                                    alt="user"
                                                />
                                            </td>
                                            <td>Chair</td>
